...
fetch("https://api.codetabs.com/v1/proxy/?quest=https://www.receiverbook.de/map?type=openwebrx&band=")
  .then(res => res.text())
  .then(html => {
